...
Suggestions to improve COSIG can be submitted by opening an issue on \href{https://github.com/reeserich/cosig/issues}{COSIG's GitHub repo}. Questions and suggestions can also be sent to \href{mailto:admin@cosig.net}{admin@cosig.net}.
