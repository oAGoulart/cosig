...
COSIG currently hosts 25 guides and was last updated on 19 May 2025.
...
Suggestions to improve COSIG can be submitted by opening an issue on \href{https://github.com/reeserich/cosig/issues}{COSIG's GitHub repo} or by emailing \href{mailto:admin@cosig.net}{admin@cosig.net}. Before contributing, read COSIG's \href{https://github.com/reeserich/cosig/blob/main/CONTRIBUTING.md}{Contributing} and \href{https://github.com/reeserich/cosig/blob/main/CODE_OF_CONDUCT.md}{Code of Conduct} pages.
